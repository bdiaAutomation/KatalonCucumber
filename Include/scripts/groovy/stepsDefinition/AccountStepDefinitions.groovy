...
import pom.Page_Account
import pom.Page_Login
...
class AccountStepDefinitions {
	...
	public void i_am_connected(Customer customer) {
		page_Account = new Page_Account();
		page_Account.clickOnLoginButton();
		page_Login = new Page_Login();
		page_Login.loginWithEmailAndPassword(customer.getEmail(), customer.getPassword());
		KeywordUtil.logInfo(customer.getEmail());
	}
